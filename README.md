...
- > ⚠️ 현재 일부 기능은 개발 중이며, 플레이 중 **일부 버그 및 미완성 UI**가 존재할 수 있습니다.  
> 해당 이슈는 추후 개발 완료 후 정리 및 수정될 예정입니다.
---

## 향후 계획 / 개선점

- 보스 컷씬 / 패턴 상태 조건 강화
- 캐릭터 직업 다양화 및 전직 시스템 확장
- 포탈 이동 시스템 구현 및 신규 맵 제작
- 현재 발견된 일부 버그 및 미완성 UI 기능은 개발 완료 이후 정리 및 수정 예정
