...
### Unity 기반 - 물고기 키우기 (2022년 2학년 수업)

- 물고기 조작 / 코인 수집 / 장애물 피하기 / 다양한 물고기 능력 구현
- FSM 기반 장애물 AI / UI 연동 / 모바일 대응 컨트롤러
- 발표자료: [2022 텀프로젝트 PPT](./Unity 기초 3D 러닝 게임.pptx)

---

### Unreal Engine 기반 - 3인칭 RPG (2024 기말 프로젝트)

- TPS 이동 / 공격 애니메이션 몽타주 / C++ Notify 기반 연속 공격
- HP, 스태미나, 무기 충돌 제어 / 다양한 상태 제한 구현
- 발표자료: [2024 RPG 프로젝트 PPT](./Unreal Engine 기반 3인칭 RPG 프로토타입.pptx)
